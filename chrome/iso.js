...
function loadStats() {
  ...
  var strCount = ($('.contrib-day .num')).html();
  var html = $.parseHTML(str);
  var countTotal = (str.match(/(((\d{1,3})(,\d{3})*)|(\d+))(.\d+)?/))[0];
  var datesTotal = $.trim(html[4].nodeValue);
  ...
  var strCount     = ($('.contrib-streak .num')).html();
  var html         = $.parseHTML(str);
  var countLongest = str.match(/(((\d{1,3})(,\d{3})*)|(\d+))(.\d+)?/)[0];
  var datesLongest = $.trim(html[4].nodeValue);

  // Current streak
  var str          = $('.contrib-streak-current').html();
  var strCount     = ($('.contrib-streak-current .num')).html();
  var html         = $.parseHTML(str);
  var countCurrent = str.match(/(((\d{1,3})(,\d{3})*)|(\d+))(.\d+)?/)[0];
  var datesCurrent = $.trim(html[4].nodeValue);
